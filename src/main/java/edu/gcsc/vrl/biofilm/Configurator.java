...
public class Configurator extends VPluginConfigurator {
    ...
    public Configurator() {
        ...
        setIdentifier(new PluginIdentifier("Biofilm-Plugin", "1.0"));
        ...
        // 
        exportPackage("edu.gcsc.vrl.biofilm");
        exportPackage("edu.gcsc.vrl.densityvis");
//        disableAccessControl(true);

        // describe the plugin
        setDescription("Biofilm Plugin");
...
//                "www.you.com", "License Name", "License Text...");
        ...
        addDependency(new PluginDependency(
                "Density-Vis-Plugin", "0.3", VersionInfo.UNDEFINED));
